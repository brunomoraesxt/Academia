...
$sql = "SELECT * from avaliacao_fisica where matricula_Aluno='$matricula'";
// mostra resultado
...
?>
    ...
    <div id='header'>
        ...
        <h1>Sistema<span class='academia_titulo'>SCA<br>Avaliação Física</span></h1>    
    ...
    <form method=post action=grava_altera_avaliacao_fisica.php enctype="multipart/form-data">
    ...
    <tr>
        <td>Data de Vencimento: </td><td><?php 
    ...
    <tr>
        <td>Obsercação: </td><td><input type=longtext size="30" style="height: 100px" name=Observacao value="<?php echo $linha['Observacao']; ?>"></td>
    </tr>
    ...
    <div id="bottom">
    <form method=post action=excluir_avaliacao_fisica_aluno.php>
